...
if (mybutton) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        toggleBtn.addEventListener("click", function () {
            let theme = html.getAttribute("data-nav-theme");

            if (theme === "dark") {
                html.setAttribute("data-nav-theme", "light");
                toggleBtn.innerHTML = "🌙";
        ...
        let savedTheme = localStorage.getItem("navTheme") || "dark";
        html.setAttribute("data-nav-theme", savedTheme);
