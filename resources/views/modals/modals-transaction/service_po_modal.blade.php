 <div class="modal fade" id="ServicePOModal" aria-labelledby="fullscreeexampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="ServicePOModalLabel">Service PO </h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="commonServicePOForm" class="row g-3 needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="row">
                        <div class="row g-1">
                            <div class="col-md-4">
                                ...
                                <div class="row g-2 mb-1">
                                    <div class="col-4">
                                        <label for="ser_po_date" class="form-label">PO Date <sup class="astric">*</sup></label>
                                    </div>
                                    <div class="col-8">
                                        <input type="text" class="form-control date-picker" id="ser_po_date" name="ser_po_date" required autocomplete="off"/>
                                        <div class="invalid-tooltip">
                                            Enter PO Date.
                                        </div>
                                    </div>
                                ...
                                <div class="row g-2 mb-1">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <select class="js-example-basic-single" name="supplier_id" id="supplier_id" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row g-2 ml-2 mb-1">
                                    ...
                                    <div class="col-8">
                                        <select class="js-example-basic-single" name="kind_attn_id" id="kind_attn_id">
                                 ...
                                 <div class="row g-2 ml-2 mb-1">
                                    <div class="col-4">
                                        <label class="form-label">Purpose <sup class="astric">*</sup></label>
                                    </div>
                                    <div class="col-8">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row g-2 ml-2 mb-1">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <select class="js-example-basic-single" name="bill_to_id" id="bill_to_id" required>
                                ...
                                <div class="row g-2 ml-2 mb-1">
                                    <div class="col-4">
                                        <label class="form-label">For Location <sup class="astric">*</sup></label>
                                    </div>
                                    <div class="col-8">
                                       
                                        <select class="js-example-basic-single" name="for_location_id" id="for_location_id" required>
                                            <option value="">Select For Location</option>
                            ...
                            <div class="card mt-3">
                                <div class="card-header align-items-center d-flex pt-0">
                                    <div class="flex-shrink-0 mr-5">
                                        <button type="button" class="btn btn-primary toggleButton" data-bs-target="#ServicePODetailsModal">Add</button>
                                    </div>
                                    <h4 class="card-title mb-0 flex-grow-1 ml-2"><b>Service PO Details</b></h4>
                                </div>

                                <div class="card-body">
                                    <div class="live-preview">
                                        <div class="table-responsive details-action">
                                            <table class="table table-bordered align-middle table-nowrap mb-0" id="ServicePODetailTable">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr class="centeralign" id="noDetails">
                                                        <td colspan="10">No Service PO Details Added</td>
                                                    </tr>
                                                </tbody>
                                                    <tfoot>
                                                        <tr>
                        ...
                        <div class="row g-1">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row g-2 ml-2 mb-1">
                                    ...
                                    <div class="col-8">
                                        <textarea class="form-control" id="terms_and_conditions" name="terms_and_conditions" rows="10"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="row g-2 ml-2 mb-1">
                                    ...
                                    <div class="col-8">
                                        <input type="text" class="form-control " id="sp_note" name="sp_note"/>  
                                    </div>
                                </div>
                                <div class="row g-2 ml-2 mb-1">
                                    <div class="col-4">
...
<script src="{{ URL::asset('views/js/service_po.js?ver='.getJsVersion()) }}"></script>
@endpush
