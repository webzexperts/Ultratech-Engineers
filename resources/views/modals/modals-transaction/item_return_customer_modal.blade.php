 <div class="modal fade" id="ItemReturnCustomerModal" aria-labelledby="fullscreeexampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="DcCustomerModalLabel">Item Return (Customer)</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="commonItemReturnCustomerForm" class="row g-3 needs-validation" novalidate>
                    @csrf
                                ...
                                <div class="row g-1 mb-1">
                                    ...
                                    <div class="col-8">
                                        <div class="d-flex gap-2 position-relative">
                                            <input type="text" class="form-control" id="return_sequence" name="return_sequence" style="max-width:80px" autofocus required>
                                             <div class="invalid-tooltip">
                                                Enter GRN No.
                                            </div>
                                            <input type="text" class="form-control" id="return_number" name="return_number" tabindex="-1" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="row g-1 mb-1">
                                    ...
                                    <div class="col-8 postition-relative">
                                        <input type="text" class="form-control trans-date-picker" id="return_date" name="return_date" required autocomplete="off">
                                        <div class="invalid-tooltip">
                                            Enter GRN Date.
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="row g-2 mb-1">
                                    ...
                                    <div class="col-8 d-flex gap-2 position-relative">
                                        <select class="js-example-basic-single skip-tab" name="customer_id" id="customer_id" required>
                                        ...
                                        <div class="invalid-tooltip">
                                         ...
                                         <button type="button" class="btn btn-success btn-sm toggleModalBtn pending_detail" id="pending_btn" disabled data-bs-target="#CustomerDCPendingModal">
                                            Pending
                                        </button>
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <!-- <div class="flex-shrink-0">
                                <button type="button" class="btn btn-primary toggleButton" data-bs-target="#ItemReturnDetailsModal">Add</button>
                            </div> -->
                        </div>
                       
                        <div class="card-body">
                            <div class="table-responsive details-action">
                                <table class="table table-bordered align-middle mb-0" id="ItemReturnDetailTable">
                                    <thead>
                                        <tr>
...
<script src="{{ URL::asset('views/js/item_return_customer.js?ver='.getJsVersion()) }}"></script>
@endpush
