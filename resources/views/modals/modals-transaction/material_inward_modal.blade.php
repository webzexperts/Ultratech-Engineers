<div class="modal fade" id="MaterialInwardModal" aria-labelledby="fullscreeexampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="MaterialInwardModalLabel">Material Inward</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="commonMaterialInwardForm" class="row g-3 needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="row">
                        <div class="row g-1">
                            ...
                            <div class="col-md-4">
                                <div class="row g-2 mb-1">
                                    <div class="col-4">
                                        <label for="material_inward_sequence" class="form-label">Inward No. <sup class="astric">*</sup></label>
                                    </div>
                                    <div class="col-8">
                                        <div class="d-flex gap-2 position-relative">
                                            <input type="text" class="form-control isNumberKey" id="material_inward_sequence" name="material_inward_sequence" style="max-width:60px" autofocus required>
                                            <input type="text" class="form-control skip-tab" id="material_inward_no" name="material_inward_no" tabindex="-1" readonly>
                                ...
                                <div class="row g-2 mb-1">
                                    <div class="col-4">
                                        <label for="material_inward_date" class="form-label">Inward Date <sup class="astric">*</sup></label>
                                    </div>
                                    <div class="col-8">
                                        <input type="text" class="form-control trans-date-picker" id="material_inward_date" name="material_inward_date" required autocomplete="off" />
                                        <div class="invalid-tooltip">Enter Inward Date.</div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row g-2 ml-2 mb-1">
                                    ...
                                    <div class="col-4 position-relative">
                                        ...
                                        <div class="invalid-tooltip">Enter PO No.</div>
                                    </div>
                                    <div class="col-4 position-relative">
                                ...
                                <div class="card">
                                    <div class="card-header align-items-center d-flex pt-0">
                                        <div class="flex-shrink-0 mr-5">
                                            <button type="button" class="btn btn-primary" data-bs-target="#MaterialInwardDetailsModal">Add</button>

                                        </div>
                                        <h4 class="card-title mb-0 flex-grow-1 ml-2"><b>Material Inward Details</b></h4>
                                    </div><!-- end card header -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <div class="table-responsive">
                                                <table class="table table-bordered align-middle table-nowrap mb-0" id="MaterialInwardDetailTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="20" id="noDetails" class="text-center">No Material Inward Details Added</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                        ...
                        <!-- <div class="row g-1 PIselected mt-2">
                            <div class="col-12 d-flex align-items-center mb-1">
                                <h5 class="mb-0 flex-grow-1">Material Inward Details</h5>
                                <button type="button" class="btn btn-primary btn-sm toggleButton" data-bs-target="#MaterialInwardDetailsModal">Add</button>
                            </div>
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-nowrap align-middle mb-0" id="MaterialInwardDetailTable">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr><td colspan="19" id="noDetails" class="text-center">No Material Inward Details Added</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="row g-1 mt-1">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row g-2 ml-2 mb-1">
                                    ...
                                    <div class="col-8">
                                        <!-- <input type="text" class="form-control" id="additional_requirement_from_customer" name="additional_requirement_from_customer" maxlength="100"> -->
                        ...
                        <!-- <div class="row g-1 mt-1">
                            <div class="col-md-6">
                                <div class="row g-2 mb-1">
                                    <div class="col-2"><label class="form-label mt-1">Additional Requirement from Customer</label></div>
                                    <div class="col-10">
                                        <textarea class="form-control" id="additional_requirement_from_customer" name="additional_requirement_from_customer" rows="2" maxlength="8000" required></textarea>
                                        <div class="invalid-tooltip">Enter Additional Requirement.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row g-2 mb-1">
                                    <div class="col-2"><label class="form-label mt-1">Special Note</label></div>
                                    <div class="col-10">
                                        <textarea class="form-control" id="special_note" name="special_note" rows="2" maxlength="8000" required></textarea>
                                        <div class="invalid-tooltip">Enter Special Note.</div>
                                    </div>
                                </div>
                            </div>
...
<script src="{{ URL::asset('views/js/material_inward.js?ver='.getJsVersion()) }}"></script>
@endpush
