                    ...
                    <div class="row mt-2">
                        <div class="row g-1 ">
                            ...
                            <div class="col-lg-4 d-flex position-relative">
                                ...
                                {{-- onkeyup="suggestProcedureReference(event,this)" --}}
                                {{-- <div id="procedure_reference_list" class="suggestion_list"></div>
                                <input type="hidden" name="procedure_reference_suggesion" id="procedure_reference_suggesion"> --}}
...
@push('script-modal')
    <script src="{{ URL::asset('views/js/procedure_reference.js?ver='.getJsVersion()) }}"></script>
@endpush
