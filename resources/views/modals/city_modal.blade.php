                            ...
                            <div class="col-md-6">
                                <div class="row g-2 mb-1">
                                    ...
                                    <div class="col-8 position-relative">
                                        ...
                                        {{-- <div id="city_name_list" class="suggestion_list"></div>
                                        <input type="hidden" name="city_suggesion" id="city_suggesion"> --}} -->
...
@push('script-modal')
    <script src="{{ URL::asset('views/js/city.js?ver='.getJsVersion()) }}"></script>
@endpush