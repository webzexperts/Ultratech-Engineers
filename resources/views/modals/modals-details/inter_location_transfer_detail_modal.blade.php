...
<div class="modal fade" id="InterLocationTransferDetailsModal" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-bs-focus="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="authModalLabel">Inter Location Transfer Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="InterLocationTransferDetailsForm" class="row g-3 needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="row mt-2">
                        <div class="col-md-8">
                            <div class="row g-2 mb-1">
                                <div class="col-4">
                                    <label for="quotd_qty" class="form-label">Material Indent No.</label>
                                </div>
                                <div class="col-8 d-flex align-items-center gap-2">
                                    <input type="text" class="form-control skip-tab" name="pi_no" id="pi_no" readonly>
                                    <input type="text" class="form-control" id="pi_date" name=
                                    "pi_date" tabindex="-1" style="width: 85px;" readonly>
                                </div>
                            </div>
                            <!-- <div class="row g-2 mb-1">
                                <div class="col-4">
                                ...
                                <div class="col-8 d-flex align-items-center gap-2">
                                    <input type="text" class="form-control isNumberKey skip-tab" name="dc_no" id="dc_no" style="width: 120px;" onblur="formatPoints(this,3)" readonly>
                                    <input type="text" class="form-control" id="dc_date" name=
                            ...
                            <div class="row g-2 mb-1">
                                ...
                                <div class="col-8">
                                    <select class="js-example-basic-single" name="item_id" id="item_id"  autofocus required>
                                        ...
                                        @forelse (getItemsForInterLocationTransfer() as $item)
                                            <option value="{{ $item->id }}" data-item_group="{{ $item->item_group }}" 
                                                   data-main_group="{{  getItemType()[$item->item_type] ?? '' }}" data-item_type="{{ $item->item_type }}" data-io_stock_qty="{{ $item->io_stock_qty}}" data-stock_sq_in="{{ $item->stock_sq_in ?? 0 }}" data-unit="{{ $item->unit }}" data-stock_rate_unit="{{$item->io_stock_rate_unit}}">
                                                   {{ $item->item_name }}
                                            </option>
                                        @empty
                                        @endforelse     
                            ...
                            <div class="row g-2 mb-1">
                                <div class="col-4">
                                    <label for="grnd_pend_qty" class="form-label">Pend. Indent Qty.</label>
                                </div>
                                <div class="col-8 d-flex align-items-center">
                                    <input type="text" class="form-control isNumberKey" name="pend_pi_qty" id="pend_pi_qty" onblur="formatPoints(this,3)"  tabindex="-1" readonly >
