<div class="modal fade" id="MaterialInwardDetailsModal" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-bs-focus="true">
    <div class="modal-dialog modal-lg" style="max-width: 1000px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Material Inward Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="MaterialInwardDetailsForm" class="row g-3 needs-validation" novalidate>
                    @csrf
                    ...
                    <input type="hidden" name="material_inward_details_id" id="material_inward_details_id" value="0"/>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6">
                            <div class="row g-2 mb-1">
                                ...
                                <div class="col-8">
                                    {{-- NABL filtering: when parent NABL = "NABL" the option set may be limited per location;
                                         for "Non NABL" all tests are allowed. Hook in JS: filterTestsByNabl(). --}}
                            ...
                            <div class="row g-2 mb-1">
                             ...
                             <!-- <div class="row g-2 mb-1">
                                 <div class="col-4"><label for="part_id" class="form-label">Part No.</label></div>
                                 <div class="col-8">
                                     <div class="otherselectwidth">
                                         <select class="js-example-basic-single suggest_part" name="part_id" id="part_id">
                                             <option value="">Select Part No.</option>
                                         </select>
                                         @if(hasAccess("part","add"))
                                             <i class="plus-icon bx bx-plus-medical" onclick="addedPart(true)" data-bs-target="#PartModal"></i>
                                         @endif
                                     </div>
                                 </div>
                             </div> -->
