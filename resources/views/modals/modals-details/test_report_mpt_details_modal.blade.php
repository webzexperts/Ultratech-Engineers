<div class="modal fade" id="MPTReportDetailsModal" aria-labelledby="MPTReportDetailsModalLabel" aria-hidden="true" data-bs-focus="true" data-custom-hide-focus="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="MPTReportDetailsModalLabel">MPT Test Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="MPTReportDetailsForm" class="row g-3 needs-validation" novalidate>
                    @csrf
                    ...
                    <input type="hidden" name="test_report_mpt_details_id" id="test_report_mpt_details_id" /> 

                    <div class="row mt-2">
                        <div class="col-12">
                            <!-- MPI Test No. -->
                            <div class="row g-2 mb-1">
                                <div class="col-4"><label for="det_mpt_test_no" class="form-label">MPT Test No. <sup class="astric">*</sup></label></div>
                                <div class="col-8">
                                    <input type="text" name="mpt_test_no" id="det_mpt_test_no" class="form-control" required>
                                    <div class="invalid-tooltip">Enter MPT Test No.</div>
                                </div>
                            </div>
                            <!-- Heat No. -->
                            <div class="row g-2 mb-1">
                            ...
                            <div class="row g-2 mb-1">
                                ...
                                <div class="col-8">
                                    <input type="text" name="discontinuity_evaluation" id="det_discontinuity_evaluation" class="form-control" onkeyup="suggestDiscontinuityEvaluation(event, this)" autocomplete="off" required>
                                    <div id="det_discontinuity_evaluation_list"></div>
                                    <input type="hidden" name="det_discontinuity_evaluation_suggestion" id="det_discontinuity_evaluation_suggestion">
