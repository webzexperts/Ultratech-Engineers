                            ...
                            <div class="col-md-6">
                                <div class="row g-1 mb-1">
                                    ...
                                    <div class="col-8 position-relative">
                                        ...
                                        {{-- onkeyup="suggestState(event,this)" --}}
                                        {{-- <div id="state_name_list" class="suggestion_list"></div>
                                        <input type="hidden" name="state_suggesion" id="state_suggesion"> --}}
...
@push('script-modal')
    <script src="{{ URL::asset('views/js/state.js?ver='.getJsVersion()) }}"></script>
@endpush