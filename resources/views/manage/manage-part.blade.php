    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Part</h5>
                <div>
                    @if(hasAccess("part","export"))
                        <a href="javascript:void(0)" class="btn btn-primary" id="export-excel">Excel</a>
                    @endif

                    @if(hasAccess("part","add"))
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#PartModal">Add</button>
                    @endif
                </div>
            </div>
            <div class="card-body">
    ...
    <script>
        ...
        var table = $('#dyntable').DataTable({
            ...
            columns: [
                ...
                { data: 'drg_no', name: 'drg_no', },
                { data: 'last_by', name: 'last_by', },
                { data: 'last_on', name: 'part.last_on', },
                { data: 'created_by', name: 'created_by', },
                { data: 'created_on', name: 'part.created_on', },
            ],
        });
