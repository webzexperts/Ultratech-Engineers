    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Material</h5>
                <div>
                    @if(hasAccess("material","export"))
                        <a href="javascript:void(0)" class="btn btn-primary" id="export-excel">Excel</a>
                    @endif

                    @if(hasAccess("material","add"))
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#MaterialModal">Add</button>
                    @endif
                </div>
            </div>
            <div class="card-body">
    ...
    <script>
        ...
        var table = $('#dyntable').DataTable({
            ...
            buttons: [{
                ...
                title:"",
                className: 'export_material d-none',
                exportOptions: { columns: ':not(:eq(0))', modifier: { page: 'all' } },
                action: newexportaction
            }],
            ajax: {
                url: "listing-material",
                type: "POST",
                headers: headerOpt,
            ...
            columns: [
                ...
                { data: 'last_on', name: 'materials.last_on', },
                { data: 'created_by', name: 'created_by', },
                { data: 'created_on', name: 'materials.created_on', },
            ],
        });
