...
@slot('title')Shift @endslot
@endcomponent

@include('modals.shift_modal')
<div class="row">
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Shift</h5>
                <div>
                    @if(hasAccess("shift","export"))
                        <a href="javascript:void(0)" class="btn btn-primary" id="export-excel">Excel</a>
                    @endif

                    @if(hasAccess("shift","add"))
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ShiftModal">Add</button>
                    @endif
                </div>
            </div>
            <div class="card-body">
    ...
    <script>
        ...
        var table = $('#dyntable').DataTable({
            ...
            columns: [
                ...
                { data: 'last_on', name: 'shift.last_on', },
                { data: 'created_by', name: 'created_by', },
                { data: 'created_on', name: 'shift.created_on', },
            ],
        });
