...
@slot('title')Reason @endslot
@endcomponent

@include('modals.reason_modal')
<div class="row">
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Reason</h5>
                <div>
                    @if(hasAccess("reason","export"))
                        <a href="javascript:void(0)" class="btn btn-primary" id="export-excel">Excel</a>
                    @endif

                    @if(hasAccess("reason","add"))
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ReasonModal">Add</button>
                    @endif
                </div>
            </div>
            <div class="card-body">
    ...
    <script>
        ...
        var table = $('#dyntable').DataTable({
            ...
            buttons: [{
                ...
                title:"",
                className: 'export_reason d-none',
            ...
            columns: [
                ...
                { data: 'last_on', name: 'reason.last_on', },
                { data: 'created_by', name: 'created_by', },
                { data: 'created_on', name: 'reason.created_on', },
            ],
        });
