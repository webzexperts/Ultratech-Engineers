    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">City</h5>
                <div>
                    @if(hasAccess("city","export"))
                        <a href="javascript:void(0)" class="btn btn-primary" id="export-excel">Excel</a>
                    @endif

                    @if(hasAccess("city","add"))
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#CityModal">Add</button>
                    @endif
                </div>
            </div>
            <div class="card-body">
    ...
    <script>
        ...
        var table = $('#dyntable').DataTable({
            ...
            columns: [
                ...
                { data: 'state_code' ,name: 'states.state_code', },
                { data: 'country_name' ,name: 'countries.country_name', },
                { data: 'last_by', name: 'last_by', },
                { data: 'last_on', name: 'cities.last_on', },
                { data: 'created_by', name: 'created_by', },
                { data: 'created_on', name: 'cities.created_on', },
            ],
        });
