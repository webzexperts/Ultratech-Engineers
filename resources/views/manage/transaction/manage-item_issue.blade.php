...
@section('title') Item Issue (Internal) @endsection
@section('css')
...
@slot('title')Item Issue (Internal) @endslot
@endcomponent

@include('modals.modals-transaction.item_issue_modal')
@include('modals.modals-details.item_issue_details')

<div class="row">
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Item Issue (Internal)</h5>
                <div>
                    @if(hasAccess("item_issue","export"))
                        <a href="javascript:void(0)" class="btn btn-primary" id="export-excel">Excel</a>
                    @endif

                    @if(hasAccess("item_issue","add"))
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ItemIssueModal">Add</button>
                    @endif
                </div>
            </div>
            <div class="card-body">
...
@section('script-manage')
     <script>
        ...
        var table = $('#dyntable').DataTable({
            ...
            buttons: [{
                extend:'excel',
                filename: 'Item Issue (Internal) List',
                title:"",
            ...
            columns: [
                ...
                { data: 'issue_sequence', name: 'item_issue.issue_sequence', visible: false, searchable: false, },
