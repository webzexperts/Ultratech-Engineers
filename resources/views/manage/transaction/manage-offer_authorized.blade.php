...
@section('title') Offer Authorized @endsection
@section('css')
<style>
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="table-responsive" style="max-height: 250px;">
                        <table id="offer_details_table" class="table nowrap align-middle table-bordered" style="width:100%">
                            ...
                            <tbody id="offer_details_body">
                                <tr>
                                    <td colspan="10" class="text-center text-muted py-3">Select an offer from the grid above to view item details.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-lg-12 text-end mt-4">
                    <button type="button" class="btn btn-success me-1" id="btn-authorize">Authorize</button>
                    <button type="button" class="btn btn-warning me-1" id="btn-unauthorize">Unauthorize</button>
                    <button type="button" class="btn btn-danger" id="btn-cancel">Reset</button>
                </div>
