...
@section('title') Pending Inquiry For Estimation & Costing @endsection
@section('css')
...
@slot('title')Pending Inquiry For Estimation & Costing @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Pending Inquiry For Estimation & Costing</h5>
                <div>
                    @if(hasAccess("pend_inq_for_ec","export"))
...
@section('script-manage')
    <script>
        ...
        var table = $('#dyntable').DataTable({
            ...
            buttons: [{
                extend:'excel',
                filename: 'Pending Inquiry For Estimation & Costing List',
                title:"",
