...
@section('title') GRN - Location Summary @endsection
@section('css')
...
@slot('title')GRN - Location Summary @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">GRN - Location Summary</h5>
                <div>
                    @if(hasAccess("grn_location_summary","export"))
...
@section('script-manage')
     <script>
        ...
        jQuery('#export-excel').on('click',function(){
            jQuery('.export_grn_location_summary').click();
        });
        ...
        function loadDataTable(){
            ...
            var formValue = Object.fromEntries(data.entries());
             ...
             table = $('#dyntable').DataTable({
                ...
                buttons: [{
                    extend:'excel',
                    filename: 'GRN - Location Summary List',
                    title:"",
                    className: 'export_grn_location_summary d-none',
                    exportOptions: {
                ...
                ajax: {
                    url: "listing-grn_location_summary",
                    type: "POST",
                    headers: headerOpt,
                    data : {
                ...
                columns: [
                    ...
                    { data: 'grn_loc_date', name: 'grn_supplier.grn_loc_date', },
                    ...
                    { data: 'remark', name: 'grn_supplier_details.remark', },
