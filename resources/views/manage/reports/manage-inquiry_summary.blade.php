...
@section('title') Inquiry Summary @endsection
@section('css')
...
@slot('title')Inquiry Summary @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Inquiry Summary</h5>
                <div>
                    @if(hasAccess("inquiry_summary","export"))
...
@section('script-manage')
    <script>
        ...
        jQuery('#export-excel').on('click',function(){
            jQuery('.export_inquiry_summary').click();
        });
        ...
        function loadDataTable() {
            ...
            var table = $('#dyntable').DataTable({
                ...
                buttons: [{
                    extend:'excel',
                    filename: 'Inquiry Summary List',
                    title:"",
                    className: 'export_inquiry_summary d-none',
                    exportOptions: {
                        columns: ':not(:eq(14))',
                        modifier: { page: 'all' }
                    },
                ...
                columns: [
                    ...
                    { data: 'inqd_feasibility_required', name: 'inquiry_details.inqd_feasibility_required', },
                    // { data: 'inqd_estimation_required', name: 'inquiry_details.inqd_estimation_required', },
