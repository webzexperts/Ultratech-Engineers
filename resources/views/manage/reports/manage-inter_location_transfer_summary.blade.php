...
@section('title') Inter Location Transfer Summary @endsection
@section('css')
...
@slot('title')Inter Location Transfer Summary @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Inter Location Transfer Summary</h5>
                <div>
                    @if(hasAccess("inter_location_transfer_summary","export"))
...
@section('script-manage')
     <script>
        ...
        jQuery('#export-excel').on('click',function(){
            jQuery('.export_inter_location_transfer_summary').click();
        });
        ...
        function loadDataTable(){
            ...
            var formValue = Object.fromEntries(data.entries());
             ...
             table = $('#dyntable').DataTable({
                ...
                buttons: [{
                    extend:'excel',
                    filename: 'Inter Location Transfer Summary List',
                    title:"",
                    className: 'export_inter_location_transfer_summary d-none',
                    exportOptions: { modifier: { page: 'all' } },
                    action: newexportaction
                }],
                ajax: {
                    url: "listing-inter_location_transfer_summary",
                    type: "POST",
                    headers: headerOpt,
                    data : {
