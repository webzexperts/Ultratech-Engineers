...
@section('title') Item Return (Customer) Summary @endsection
@section('css')
...
@slot('title')Item Return (Customer) Summary @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Item Return (Customer) Summary</h5>
                <div>
                    @if(hasAccess("item_return_customer_summary","export"))
...
@section('script-manage')
     <script>
        ...
        jQuery('#export-excel').on('click',function(){
            jQuery('.export_item_return_customer_summary').click();
        });
        ...
        function loadDataTable(){
            ...
            var formValue = Object.fromEntries(data.entries());
             ...
             table = $('#dyntable').DataTable({
                ...
                buttons: [{
                    extend:'excel',
                    filename: 'Item Return Customer Summary List',
                    title:"",
                    className: 'export_item_return_customer_summary d-none',
                    exportOptions: { modifier: { page: 'all' } },
                    action: newexportaction
                }],
                ajax: {
                    url: "listing-item_return_customer_summary",
                    type: "POST",
                    headers: headerOpt,
                    data : {
