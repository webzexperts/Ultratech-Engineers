...
@section('title') GRN - Supplier Summary @endsection
@section('css')
...
@slot('title')GRN - Supplier Summary @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">GRN - Supplier Summary</h5>
                <div>
                    @if(hasAccess("grn_supplier_summary","export"))
...
@section('script-manage')
     <script>
        ...
        jQuery('#export-excel').on('click',function(){
            jQuery('.export_grn_supplier_summary').click();
        });
        ...
        function loadDataTable(){
            ...
            var formValue = Object.fromEntries(data.entries());
             ...
             table = $('#dyntable').DataTable({
                ...
                buttons: [{
                    extend:'excel',
                    filename: 'GRN - Supplier Summary List',
                    title:"",
                ...
                ajax: {
                    url: "listing-grn_supplier_summary",
                    type: "POST",
                    headers: headerOpt,
                    data : {
