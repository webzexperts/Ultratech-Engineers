...
@section('title') Pending Inquiry For Quotation @endsection
@section('css')
...
@slot('title')Pending Inquiry For Quotation @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Pending Inquiry For Quotation</h5>
                <div>
                    @if(hasAccess("pend_inq_for_quotation","export"))
...
@section('script-manage')
    <script>
        ...
        var table = $('#dyntable').DataTable({
            ...
            buttons: [{
                extend:'excel',
                filename: 'Pending Inquiry For Quotation List',
                title:"",
            ...
            ajax: {
                url: "listing-pend_inq_for_quotation",
                type: "POST",
                headers: headerOpt,
