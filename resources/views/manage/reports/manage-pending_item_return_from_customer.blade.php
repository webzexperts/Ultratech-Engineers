...
@section('title') Pending Item Return from Customer @endsection
@section('css')
...
@slot('title')Pending Item Return from Customer @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Pending Item Return from Customer</h5>
                <div>
                    @if(hasAccess("pending_item_return_from_customer","export"))
...
@section('script-manage')
    <script>
        ...
        jQuery('#export-excel').on('click',function(){
            jQuery('.export_pending_item_return_from_customer').click();
        });
        var table = $('#dyntable').DataTable({
            ...
            ajax: {
                url: "listing-pending_item_return_from_customer",
                type: "POST",
                headers: headerOpt,
            ...
            columns: [
                ...
                // { data: 'ref_no_date', name: 'delivery_challan_customer.ref_no_date' },
