...
@section('title') Purchase Order Summary @endsection
@section('css')
...
@slot('title')Purchase Order Summary @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Purchase Order Summary</h5>
                <div>
    ...
    <script>
        ...
        function loadDataTable(){
            ...
            var table = $('#dyntable').DataTable({
                ...
                buttons: [{
                    extend:'excel',
                    filename: 'Purchase Order Summary List',
                    title:"",
                ...
                columns: [
                    ...
                    { data: 'pod_description', name: 'purchase_order_details.pod_description', },
