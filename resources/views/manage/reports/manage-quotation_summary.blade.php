...
@section('title') Quotation Summary @endsection
@section('css')
...
@slot('title')Quotation Summary @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Quotation Summary</h5>
                <div>
                    @if(hasAccess("quotation_summary","export"))
        ...
        setTimeout(() => {
         ...
         function loadDataTable() {
            ...
            var table = $('#dyntable').DataTable({
                ...
                buttons: [{
                    extend:'excel',
                    filename: 'Quotation Summary List',
                    title:"",
                    className: 'export_qs d-none',
                    exportOptions: {  modifier: { page: 'all' } },
                    action: newexportaction
                }],
                ajax: {
                    url: "listing-quotation_summary",
                    type: "POST",
                    headers: headerOpt,
                    data : {
                ...
                columns: [
                    ...
                    { data: 'quotd_process_at_id' , name: 'quotation_details.quotd_process_at_id' },
                    ...
                    //{ data: 'quotd_minimum_charge' , name: 'quotation_details.quotd_minimum_charge' },
                   // { data: 'quotd_minimum_charge_id', name: 'quotation_details.quotd_minimum_charge_id', },
                   // { data: 'quotd_conveyance_charge', name: 'quotation_details.quotd_conveyance_charge', },
                   // { data: 'quotd_remark', name: 'quotation_details.quotd_remark', },
                    { data: 'quot_offer_validity', name: 'quotation.quot_offer_validity', },
