...
@section('title') Feasibility Review Summary @endsection
@section('css')
...
@slot('title')Feasibility Review Summary @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Feasibility Review Summary</h5>
                <div>
                    @if(hasAccess("po_summary","export"))
                        <a href="javascript:void(0)" class="btn btn-primary" id="export-excel">Excel</a>
                    @endif
                </div>
            </div>
            <div class="card-body">
                <form id="frSearchForm" name="frSearchForm" class="stdform">
...
@section('script-manage')
    <script>
        ...
        function loadDataTable(){
            ...
            var data = new FormData(document.getElementById('frSearchForm'));
            ...
            var table = $('#dyntable').DataTable({
                ...
                buttons: [{
                    extend:'excel',
                    filename: 'Feasibility Review Summary List',
                    title:"",
                    className: 'export_fr d-none',
                    exportOptions: {  modifier: { page: 'all' } },
                    action: newexportaction
                }],
                ajax: {
                    url: "listing-fr_summary",
                    type: "POST",
                    headers: headerOpt,
                    data : {
