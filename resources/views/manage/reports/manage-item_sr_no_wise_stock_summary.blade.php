...
@section('title') Item (Sr. No. wise) Stock Summary @endsection
@section('css')
...
@slot('title')Item (Sr. No. wise) Stock Summary @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
           <div class="card-header d-flex align-items-center pb-2">
                <h5 class="card-title mb-0 flex-grow-1">Item (Sr. No. wise) Stock Summary</h5>
                <div>
                    @if(hasAccess("item_sr_no_wise_stock_summary","export"))
...
@section('script-manage')
     <script>
        ...
        jQuery('#export-excel').on('click',function(){
            jQuery('.export_item_sr_no_wise_stock_summary').click();
        });
        ...
        function loadDataTable(){
            ...
            columns.push(
             ...
             table = $('#dyntable').DataTable({
                ...
                buttons: [{
                    extend:'excel',
                    filename: 'Item (Sr. No. wise) Stock Summary List',
                    title:"",
                    className: 'export_item_sr_no_wise_stock_summary d-none',
                    exportOptions: { modifier: { page: 'all' } },
                    action: newexportaction
                }],
                ajax: {
                    url: "listing-item_sr_no_wise_stock_summary",
                    type: "POST",
                    headers: headerOpt,
