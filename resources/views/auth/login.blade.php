                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    @csrf
                                     @if ($errors->has('wrong_details'))
                                        <div class="alert alert-danger">
                                            {{ $errors->first('wrong_details') }}
                                        </div>
                                    @endif
                                    <div class="mb-3">
                                        <label for="user_name" class="form-label">Username <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control @error('user_name') is-invalid @enderror input-lower-case" id="user_name" name="user_name" placeholder="Enter User Name" autofocus>
                                        @error('user_name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input type="password" class="form-control pe-5 password-input @error('password') is-invalid @enderror input-lower-case" name="password" placeholder="Enter Password" id="password-input" value="">
