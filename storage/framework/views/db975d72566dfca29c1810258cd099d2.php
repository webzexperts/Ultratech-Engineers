                                ...
                                <div class="col-8">
                                    <div class="otherselectwidth">
                                        <select class="js-example-basic-single suggest_type_of_job" name="type_of_job_id" id="type_of_job_id" required>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = getTypeOfJob(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $toj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($toj->id); ?>"><?php echo e($toj->type_of_job); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                        </select>
                                        <div class="invalid-tooltip">Select Type of Job.</div>
                                        <?php if(hasAccess("type_of_job","add")): ?>
                                ...
                                <div class="col-8">
                                    <div class="otherselectwidth">
                                        <select class="js-example-basic-single suggest_job_description" name="job_desc_id" id="inward_job_desc_id" required>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = getMiJobDescription(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($jd->id); ?>" data-parts="<?php echo e(json_encode($jd->parts)); ?>"><?php echo e($jd->job_description); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                        </select>
                                ...
                                <div class="col-8">
                                    <div class="otherselectwidth">
                                        <select class="js-example-basic-single suggest_material_name" name="material_id" id="material_id" required>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = getMaterial(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($mat->id); ?>"><?php echo e($mat->material); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                        </select>
                                        <div class="invalid-tooltip">Select Material.</div>
                                        <?php if(hasAccess("material","add")): ?>
                                ...
                                <div class="col-8">
                                    <div class="otherselectwidth">
                                        <select class="js-example-basic-single mst_area_of_coverage" name="area_of_coverage_id" id="area_of_coverage_id" required>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = getAreaOfCoverage(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($aoc->area_of_coverage_id); ?>"><?php echo e($aoc->area_of_coverage); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                        </select>
                                ...
                                <div class="col-8">
                                    <div class="otherselectwidth">
                                        <select class="js-example-basic-single mst_procedure_reference" name="procedure_ref_id" id="procedure_ref_id">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = getProcedureReferance(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($pr->procedure_reference_id); ?>"><?php echo e($pr->procedure_reference); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                        </select>
                                ...
                                <div class="col-8">
                                    <div class="otherselectwidth">
                                        <select class="js-example-basic-single mst_evaluation_as_per" name="evaluation_as_per_id" id="evaluation_as_per_id">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = getEvaluationAsPer(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($eap->evaluation_as_per_id); ?>"><?php echo e($eap->evaluation_as_per); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                        </select>
                                ...
                                <div class="col-8">
                                    <div class="otherselectwidth">
                                        <select class="js-example-basic-single suggest_acceptance_standard" name="acceptance_standard_id" id="acceptance_standard_id">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = getAcceptanceStandards(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($acs->id); ?>"><?php echo e($acs->acceptance_standard); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                        </select>
                                        <?php if(hasAccess("acceptance_standard","add")): ?>
...
<?php /**PATH F:\xampp\htdocs\ultratech-cbs\resources\views/modals/modals-details/offer_details_modal.blade.php ENDPATH**/ ?>