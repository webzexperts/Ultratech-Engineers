                                    ...
                                    <div class="col-8">
                                        <div class="otherselectwidth">
                                            <select class="js-example-basic-single suggest_customer_name" name="customer_id" id="customer_id" required>
                                                ...
                                                <?php $__empty_1 = true; $__currentLoopData = getCustomers(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <div class="row g-2 ml-2 mb-1">
                                    ...
                                    <div class="col-8">
                                        <select class="js-example-basic-single skip-tab" name="prepared_by_user_id" id="prepared_by_user_id" readonly>
                                            <?php $__empty_1 = true; $__currentLoopData = getUsers(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($users->id); ?>" <?php echo e(auth()->id() == $users->id ? 'selected' : ''); ?>><?php echo e($users->person_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
...
<script>
    let loginUserId = <?php echo e(auth()->id()); ?>;
    let checkFileRoute = "<?php echo e(route('check-file_exists')); ?>";
    window.locationNablDefault = "<?php echo e(getCurrentLocation()->location_nabl_applicable == 'Yes' ? 'NABL' : 'Non NABL'); ?>";
    window.locationNablTests = "<?php echo e(getCurrentLocation()->location_nabl_test ?? ''); ?>";
</script>
<script src="<?php echo e(URL::asset('views/js/offer.js?ver='.getJsVersion())); ?>"></script>
<?php $__env->stopPush(); ?>
<?php /**PATH F:\xampp\htdocs\ultratech-cbs\resources\views/modals/modals-transaction/offer_modal.blade.php ENDPATH**/ ?>