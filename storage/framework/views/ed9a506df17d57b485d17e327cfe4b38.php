                                ...
                                <div class="row g-2 ml-2 mb-1">
                                    ...
                                    <div class="col-8">
                                        <select class="js-example-basic-single" name="rt_isotope" id="rt_isotope" required>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = getIsotopeType(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $isotope_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <option value="<?php echo e($isotope_type); ?>"><?php echo e($isotope_type); ?></option>
...
<?php $__env->startPush('script-modal'); ?>
    <script src="<?php echo e(URL::asset('views/js/rt_camera.js?ver='.getJsVersion())); ?>"></script>
<?php $__env->stopPush(); ?><?php /**PATH F:\xampp\htdocs\ultratech-cbs\resources\views/modals/rt_camera_modal.blade.php ENDPATH**/ ?>